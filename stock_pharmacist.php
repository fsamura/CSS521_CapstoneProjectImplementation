...
<html>
<head>
<title><?php echo $user;?> - Pharmacy Mangement System</title>
...
<div id="content">
<div id="header">
<h1><a href="#"><img src="images/pms.jpg"></a> Pharmacy Mangement System</h1></div>
<div id="left_column">
<div id="button">
<ul>
...
<div id="tabbed_box" class="tabbed_box">
    <h4>Pharmacist Manage Stock</h4>
<hr/>
    <div class="tabbed_area">

        <ul class="tabs">
            <li><a href="javascript:tabSwitch('tab_1', 'content_1');" id="tab_1" class="active">Pharmacist View Stock</a></li>
            <li><a href="javascript:tabSwitch('tab_2', 'content_2');" id="tab_2">Pharmacist Add Medicine</a></li>
