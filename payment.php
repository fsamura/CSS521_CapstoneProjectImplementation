...
<div id="content">
<div id="header">
<h1><a href="#"><img src="images/pms.jpg"></a> Pharmacy Management System</h1></div>
<div id="left_column">
<div id="button">
		<ul>
...
-- <div id="tabbed_box" class="tabbed_box">
    <h4>Cashier Manage Payments</h4>
<hr/>
    <div class="tabbed_area">

        <ul class="tabs">
            <li><a href="javascript:tabSwitch('tab_1', 'content_1');" id="tab_1"> Cashier Process payments</a></li>
...
<div id="footer" align="Center"> Pharmacy Management System 2021</div>
</div>
</body>
</html>
